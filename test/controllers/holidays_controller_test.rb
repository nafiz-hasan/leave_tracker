...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { description: @holiday.description, reason: @holiday.reason, status: @holiday.status, type: @holiday.type, user_id: @holiday.user_id }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { description: @holiday.description, reason: @holiday.reason, status: @holiday.status, type: @holiday.type, user_id: @holiday.user_id }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
